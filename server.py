...
def route_index():
    try:
        ...
        for peer in output.split("\n")[1:]:
            ...
            peers_html += """<tr>
                                <td class="align-middle"><a class="link-normal" target="_blank" href="https://bgp.tools/asn/""" + \
                          elements[2] + """">AS""" + elements[2] + """</a></td>
                                ...
                                <td class="align-middle pt-3">
                                    <button class="btn btn-danger m-1" onclick="window.location = '/delete?peer=""" + \
                          elements[0] + """'">Delete</button>
                                </td>
                            </tr>
                            """
